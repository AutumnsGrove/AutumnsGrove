...
## CLI Tools & Utilities
- [ASCIIClock](https://github.com/AutumnsGrove/ASCIIClock) - Simple CLI tool to display a clock in a terminal window
- [EmojiKitchen](https://github.com/AutumnsGrove/EmojiKitchen) - CLI Tool to return merged Emojis
- [yt-thumbs](https://github.com/AutumnsGrove/yt-thumbs) - UV tool for extracting the Thumbnail of any YouTube video
