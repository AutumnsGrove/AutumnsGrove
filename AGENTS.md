...
- Framework: TBD (Flask/FastAPI for backend, vanilla JS for frontend)
- Key Libraries: TBD
- Package Manager: UV (Python), npm (JavaScript)

## Architecture Notes
Static website with potential for dynamic content. Organized around blog posts, project showcases, and article sharing. Clean, simple architecture focusing on content delivery and user experience.
...
🤖 Generated with [Kimi K2](https://kimi.moonshot.cn)
